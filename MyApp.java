...
public class MyApp extends JFrame {
	...
	public MyApp() {
		...
		btnNewButton.setIcon(new ImageIcon(MyApp.class.getResource("Notepad.jpg")));
		
		JLabel lblJavaApplicationWorld = new JLabel("Java Application World");
		lblJavaApplicationWorld.setFont(new Font("Tahoma", Font.ITALIC, 21));
		lblJavaApplicationWorld.setForeground(new Color(204, 52, 51));
		...
		button.setIcon(new ImageIcon(MyApp.class.getResource("calculator.png")));
		...
		button_1.setIcon(new ImageIcon(MyApp.class.getResource("ip.jpg")));
		...
		button_2.setIcon(new ImageIcon(MyApp.class.getResource("tictactoe.png")));
		
		JButton button_3 = new JButton("");
		button_3.setIcon(new ImageIcon(MyApp.class.getResource("picturepuzzle.png")));
		...
		button_4.setIcon(new ImageIcon(MyApp.class.getResource("wordcount.jpg")));
		...
		button_5.setIcon(new ImageIcon(MyApp.class.getResource("puzzlegame.png")));
		...
		button_6.setIcon(new ImageIcon(MyApp.class.getResource("quiz.jpg")));
		...
		button_7.setIcon(new ImageIcon(MyApp.class.getResource("sourcecode.png")));
